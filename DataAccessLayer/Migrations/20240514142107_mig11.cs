    ...
    public partial class mig11 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 102,
                columns: new[] { "ParagraphContent", "ParagraphTitle" },
                values: new object[] { "Şifreli veriler üzerinde sınırlı bir şekilde matematiksel işlemler yapabilme yeteneğine sahiptir. Yani, şifrelenmiş veriler üzerinde belirli matematiksel işlemleri gerçekleştirebilirsiniz, ancak tüm işlemleri yapamazsınız.\r\n\r\nGenellikle, kısmen homomorfik şifrelemelerde sınırlı işlem türleri vardır. Örneğin, toplama veya çarpma gibi tek bir işlemi gerçekleştirebilirler, ancak her ikisini birden yapamazlar. Bu tür şifreleme çözümleri, belirli kullanım durumları için yeterli olabilir, ancak tam homomorfik şifreleme kadar geniş bir işlem yelpazesine sahip değildirler.\r\n\r\nKısmen homomorfik şifreleme, özellikle veri gizliliğinin korunması gereken uygulamalarda kullanışlı olabilir. Örneğin, verileri güvenli bir şekilde işlemek için bulut bilişim ortamlarında veya veri paylaşımı senaryolarında kullanılabilirler.", "2. Kısmi Homomorfik Şifreleme (Partially Homomorphic Encryption - PHE):" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 103,
                columns: new[] { "ParagraphContent", "ParagraphTitle" },
                values: new object[] { "Şifrelenmiş veriler üzerinde sınırlı bir şekilde matematiksel işlemler yapabilme yeteneğine sahiptir. Yani, şifreli veriler üzerinde birkaç matematiksel işlem gerçekleştirebilirsiniz, ancak tam homomorfik şifreleme kadar kapsamlı değildir.\r\n\r\nGenellikle, biraz homomorfik şifreleme çözümleri, toplama ve çarpma gibi belirli işlemleri gerçekleştirebilir, ancak sınırlı sayıda işlem yapılabilmektedir. Örneğin, verileri şifreli olarak bulutta saklamak ve bulutta hesaplamalar yapmak için kullanılabilirler.\r\n\r\nSHE, tam homomorfik şifreleme kadar geniş bir işlem yelpazesine sahip olmasa da, belirli kullanım durumlarında yeterli olabilir. Özellikle, veri gizliliğinin korunması gereken uygulamalarda veya güvenli hesaplama gerektiren senaryolarda kullanışlı olabilirler.", "3. Biraz Homomorfik Şifreleme (Somewhat Homomorphic Encryption - SHE):" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 102,
                columns: new[] { "ParagraphContent", "ParagraphTitle" },
                values: new object[] { "PHE, şifreli metin üzerinde belirli türde matematiksel işlemleri gerçekleştirmeye izin verir.\r\n				Genellikle toplama veya çarpma işlemlerine izin veren bir homomorfizm türüdür.\r\n				PHE, özellikle belirli uygulamalar için daha hızlı ve daha az hesaplama maliyetine sahiptir.\r\n				Ancak tam anlamıyla genel işlemleri desteklemez.", "2. Çıkarma Homomorfizmi (Partially Homomorphic Encryption - PHE):" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 103,
                columns: new[] { "ParagraphContent", "ParagraphTitle" },
                values: new object[] { "Somewhat homomorfik şifreleme, genellikle çarpma işlemlerine izin veren bir homomorfizm türüdür.\r\n				Bu, genellikle veri analitiği gibi belirli uygulamalarda kullanışlıdır.\r\n				Bu tür şifreleme yöntemleri, genellikle belirli sayıda çarpma işlemine izin verir. Bu sınırlama,\r\n				tamamen genel olmayan bir homomorfizmi temsil eder.", "3. Çarpma Homomorfizmi (Somewhat Homomorphic Encryption):" });
        }
    }
}
